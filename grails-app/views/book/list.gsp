                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="bbRating" title="${message(code: 'book.bbRating.label', default: 'Bb Rating')}" />
                            ...
                            <g:sortableColumn property="createdBy" title="${message(code: 'book.createdBy.label', default: 'Created By')}" />
                    ...
                    <g:each in="${bookInstanceList}" status="i" var="bookInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: bookInstance, field: "bbRating")}</td>
                        
                            <td>${fieldValue(bean: bookInstance, field: "bookId")}</td>
                        
                            <td>${fieldValue(bean: bookInstance, field: "createDate")}</td>
                        
                            <td>${fieldValue(bean: bookInstance, field: "createdBy")}</td>
